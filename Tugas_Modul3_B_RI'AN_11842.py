...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1842</h1>", unsafe_allow_html=True)
...
st.sidebar.markdown("<h3 class='header-text'>Upload File dan Input Nulai</h3>", unsafe_allow_html=True)
uploaded_file = st.sidebar.file_uploader("Upload file dataset_regresi_IPL.csv", type=["csv"])
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_X_YYYYY'
